...
where the factor levels are set. The usual warnings and messages still apply.
...
Maybe I'll add some functionality around this in the future.
...
coding, deviation coding, sum to zero coding, and contrast coding. When
referring specifically to coding factors with 2 levels, sometimes the numbers
...
the two (sometimes the transpose is ommitted depending on the author, which means
